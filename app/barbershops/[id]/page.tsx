...
import { getBarbershopsById } from "../../../data/barbershops";
...
const BarbeshopPage = async ({ params }: PageProps<"/barbershops/[id]">) => {
  const { id } = await params;
  const barbershopId = Array.isArray(id) ? id[0] : id;
  const barbershop = await getBarbershopsById(barbershopId);
